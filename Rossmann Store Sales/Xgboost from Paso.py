...
train = pd.read_csv("C:/Users/qiushi/OneDrive/kaggle/Rossmann Store Sales/train.csv")
test = pd.read_csv("C:/Users/qiushi/OneDrive/kaggle/Rossmann Store Sales/test.csv")
store = pd.read_csv("C:/Users/qiushi/OneDrive/kaggle/Rossmann Store Sales/store.csv")
...
error = rmspe(np.exp(train_probs) - 1, X_test['Sales'])
print('error', error)
...
submission.to_csv("C:\\Users\\qiushi\\OneDrive\\kaggle\\Rossmann Store Sales\\xgboost_kscript_submission.csv",
                  index=False)
